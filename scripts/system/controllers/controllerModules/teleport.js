...
(function() { // BEGIN LOCAL_SCOPE
    ...
    function Teleporter(hand) {
        ...
        this.isReady = function (controllerData, deltaTime) {
            ...
            if (!controllerData.stickTouch[this.hand] || Math.abs(controllerData.yAxis[this.hand]) > STICK_DEADZONE || Math.abs(controllerData.xAxis[this.hand]) > STICK_DEADZONE) {
                this.timer = 0;
                return makeRunningValues(false, [], []);
            }
            ...
            var start = controllerData.stickTouch[this.hand] && this.inBounds && !controllerData.stickClicks[this.hand] && this.yAxis < STICK_DEADZONE && this.xAxis < STICK_DEADZONE;
        ...
        this.registerTouchMappings = function () {
            if (Controller.Hardware.OculusTouch && !this.touchMapped) {
                ...
                touchMapping.from(this.hand === LEFT_HAND ? Controller.Hardware.OculusTouch.LX : Controller.Hardware.OculusTouch.RX).peek().to(_this.touchX);
